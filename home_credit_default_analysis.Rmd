...
author: "Astha K C, Max R, Jordan S"
date: "2025-10-26"
...
## Astha
Built the logistic regression and random forest models used in the notebook, as well as made the structure for AUC evaluation of the models.
## Jordan
Provided the commentary in the modeling section, did hyperparameter tuning for the MLP models, got submission ready for Kaggle and submitted, created and summarized the non-AUC performance metrics of each model, wrote the 'Results' section and cleaned up for final submission.
## Max
I built the MLP models seen in the notebook, as well as edited the overall structure of the code to be consistent as one cohesive notebook. I was also the main writer for the ‘Introduction’ and ‘Data Preparation’ sections.
